...
def process_communities(community_file, combined_file, base_output_name):
    ...
    for community in communities:
        ...
        output_df.to_excel(writer, sheet_name=community_name[:31], index=False)  # sheet_name max length is 31 characters

    writer.close()

# Usage
#process_communities('leiden_communities_Class_C_Bla_40_gene_10_combine_50_June_26.txt', 'combined_Kofam_cdhit_class_C_Bla_40_gene_10_combine_50.txt', 'Class_C_Bla_40_gene_10_combine_50_June_26')
